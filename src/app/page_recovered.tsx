...
type Tab = "beranda" | "program" | "bootcamp" | "mentor" | "kemitraan" | "info-lomba" | "tentang-kami";

export default function Home() {
  const [activeTab, setActiveTab] = useState<Tab>("kemitraan"); // Defaulting to "kemitraan" for immediate view of the new tab
  ...
  return (
    <div className="min-h-screen bg-brand-dark flex flex-col font-sans selection:bg-brand-purple selection:text-white">
      {/* HEADER / NAVBAR */}
      <header className="sticky top-0 z-50 glassmorphism border-b border-white/5 px-6 lg:px-16 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-7 lg:gap-8">
            {[
              ...
              <button
                ...
                className={`relative py-2 text-xs lg:text-sm font-medium transition-colors hover:text-white cursor-pointer ${
                  activeTab === tab.id ? "text-white font-semibold" : "text-brand-muted"
                }`}
              >
                {tab.label}
                {activeTab === tab.id && (
          ...
          <div className="flex items-center gap-4">
            <button className="hidden sm:inline-block px-5 py-2 text-sm font-semibold text-white border border-white/10 rounded-xl hover:bg-white/5 transition-all">
              Masuk
            </button>
      ...
      <main className="flex-grow">
        ...
        {/* TAB PLACEHOLDERS */}
        {activeTab !== "beranda" && activeTab !== "program" && activeTab !== "info-lomba" && activeTab !== "tentang-kami" && activeTab !== "kemitraan" && (
      ...
      <footer className="bg-[#020308] border-t border-white/5 pt-16 pb-8 px-6 lg:px-16 text-xs text-brand-muted">
        ...
        <div className="max-w-7xl mx-auto pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-brand-muted">
          <div>
